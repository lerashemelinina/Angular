import { ArticleInfo } from "../models/articleInfo.model";
import {Injectable} from '@angular/core';

@Injectable()
export class articleInfoService {

chosenArticle={chosen:undefined};



setChosenArticle(article:ArticleInfo){
  
    this.chosenArticle.chosen=article;
    console.log(`service console log: ${this.chosenArticle.chosen.author_display}`);
    
}

    articleFullList:ArticleInfo[]=[
